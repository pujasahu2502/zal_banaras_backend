var imgArray = [];
//======================== Get Add Model ==============
$(document).on('click', '.add-listing-modal', function () {
  $('.upload__img-wrap').addClass('d-none')
  var id = '#listningModal'
...
//=======================get edit model===================
$(document).on('click', '.edit-listing-modal', function () {
...
$(document).on('click', '.delete-listing', function () {
  ...
  Swal.fire({
    title: 'Are you sure?',
    text: "Once deleted, you will not be able to revert this listing!",
    icon: 'error',
...
//===================== Add Store Method ====================
$(document).on('click', '.save-listening', function () {
  var formId = '#AddListningForm'
  var url = $(this).attr('data-url')
  ...
  $.ajax({
    ...
    success: function (response) {
      if (response.status == 'error') {
        ...
        $(formId)[0].reset()
        $('.listing-table').html(response.output)
        //close model
...
// ========================== Webinar Status ======================
$(document).on('click', '.listing-status', function () {
