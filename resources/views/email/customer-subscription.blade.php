                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="font-family: 'Lato',sans-serif; padding-top: 30px;">
                                    <strong>Hi, <strong>{{ $subscription['email'] }}</strong>!</strong>
                                    <br><br><br>
                                    Our administrator team will contact you soon by email.
                                    <br><br>
                                    If you didn't request to change your password, please let us know immediately.
                                    <br><br><br><br>
                                    <div>
