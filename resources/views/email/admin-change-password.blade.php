                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="font-family: 'Lato',sans-serif; padding-top: 30px;">
                                    <strong>Hi, <strong>{{ $user['first_name'] }}</strong>!</strong>
                                    <br><br><br>
                                    ...
                                    <br><br><br><br>
                                    <div>
                                        <a style="background-color:#f4dd89;color:#fff;font-size:18px;padding:10px 0;border:solid 1px #f4dd89!important;border-radius:4px;text-decoration:none;display:block;width:270px;text-align:center;font-weight:bold;margin:0 auto" href="#" target="_blank">Contact Us</a>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
