   ...
   <div class="add-detail mt-10">
      ...
      <div class="w-30 float-right mt-10">
         ...
         <p class="m-0 pt-5 text-bold w-100">Invoice Id - <span
            class="gray-color">{{ $booking->invoice_id ?? '-' }}</span></p>
         <p class="m-0 pt-5 text-bold w-100">Order Id - <span
            class="gray-color">{{ $booking->order_number ?? '-' }}</span></p>
         <p class="m-0 pt-5 text-bold w-100">Order Date - <span
            class="gray-color">{{ dateFormatWithMonthName($booking->created_at) ?? '-' }}</span></p>
      </div>
        ...
        <table class="table w-100 mt-10">
            <thead>
                <tr>
                    ...
                    <th class="w-50">Raffles Detail</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="width: 50%; border: 1px solid #d2d2d2;">
                        <table class="border=0 w-100">
                            ...
                            <tr style="line-height:1.5;">
                                <td class="font-weight-bold" style="width: 15%;">{{ __('Address') }}</td>
                                <td style="width: 20px">:</td>
                                <td>{{ $booking->shippingAddress->address1 . ' ' . $booking->shippingAddress->address2 . ' ' . $booking->shippingAddress->city . ',' . $booking->shippingAddress->state . ',' . $booking->shippingAddress->country . ',' . $booking->shippingAddress->zip_code }}
                                </td>
                            </tr>
                        </table>
                    </td>
                    <td style="width: 50%; border: 1px solid #d2d2d2;">
                        <table class="border=0 w-100">
                            ...
                            <tr style="line-height:1.5;">
                                ...
                                <td style="width: 20px">:</td>
                                <td>{{ dateFormatWithMonthName($booking->webinar->releasing_date) ?? '-' }}&nbsp;{{ $booking->webinar->releasing_time ?? '-' }}
                                </td>
                            </tr>
                            <tr style="line-height:1.5;">
